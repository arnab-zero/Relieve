        ...
        <div className="font-manrope bg-blue-primary border rounded-t-lg p-4 mb-4">
            ...
            <div className="text-center text-base-300 mb-4">
                <div className="flex justify-center items-center mb-2">
                    ...
                    <span className="text-lg font-bold">National Emergency: {nationalEmergency.police}</span>
                </div>
            </div>
            {displayContacts.map((upazila, index) => (
                <div key={index} className="py-2">
                    <h3 className="text-lg font-semibold text-base-300">{upazila.name} ({upazila.zilla})</h3>
                    <div className="px-4">
